...
.build:
	cd $(BASE_DIR) && docker build --pull -f $(BASE_DIR)/database/Dockerfile --target=prod --no-cache --rm -t iqbberlin/studio-lite-db:$(TAG) -t scm.cms.hu-berlin.de:4567/iqb/studio-lite/iqbberlin/studio-lite-db:$(TAG) .
