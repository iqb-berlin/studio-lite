...
test-e2e-dev:
	docker compose\
			--env-file $(STUDIO_LITE_BASE_DIR)/.env.dev\
...
test-e2e-ui-chrome-mobile-dev:
	docker compose\
			--env-file $(STUDIO_LITE_BASE_DIR)/.env.dev\
			-f $(STUDIO_LITE_BASE_DIR)/docker-compose.e2e.yaml\
		run --rm test-e2e-ui-chrome-mobile
...
test-e2e-ui-firefox-mobile-dev:
	docker compose\
			--env-file $(STUDIO_LITE_BASE_DIR)/.env.dev\
			-f $(BASE_DIR)/docker-compose.e2e.yaml\
		run --rm test-e2e-ui-firefox-mobile
...
test-e2e-ui-edge-mobile-dev:
	docker compose\
			--env-file $(BASE_DIR)/.env.dev\
			-f $(BASE_DIR)/docker-compose.e2e.yaml\
		run --rm test-e2e-ui-edge-mobile
