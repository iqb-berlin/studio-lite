...
export class UnitsController {
  ...
  async findOnesMetadata(@WorkspaceId() workspaceId: number,
    @Param('id', ParseIntPipe) unitId: number): Promise<UnitMetadataDto> {
  ...
  @ApiTags('workspace unit')
  async findOnesDefinition(@WorkspaceId() workspaceId: number,
    @Param('id', ParseIntPipe) unitId: number): Promise<UnitDefinitionDto> {
