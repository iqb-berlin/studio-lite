...
declare namespace Cypress {
  ...
  interface Chainable {
    ...
    updateCommentAPI(wsId: string, unitId: string, commentId:string, comment: CommentData, token:string): // 68
    ...
    deleteUnitsAPI(qs: string[], wsId: string, token: string): Chainable<Response>; // 70
