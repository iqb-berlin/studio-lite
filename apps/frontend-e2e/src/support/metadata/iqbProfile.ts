...
export const IqbProfileExamples = new Map <string, any>([
  ...
  ['uEN', new Map<string, string>([['Textniveau (GeR)', 'A1'],
    ...
    ['Andere Textsorte', 'Homy'], ['Thema', 'Berufsorientierung'], ['Anderes Thema', 'Homyy'],
    ['Länge des verwendeten Audioauszugs', '3:30'], ['Wortanzahl', '150'], ['Aufgabenzeit', '4:00'],
    ['Vermerk / Zitation', 'DOIEnglisch'], ['Transkript Original', 'Englisch Transkript Original'],
    ['Anzahl der Sprecher*innen', '5'], ['Sprechtempo', 'schnell'], ['Variante', 'Walisisch'],
    ['Nebengeräusche', 'auch erschwerend'], ['Transkript zur Aufgabe', 'Englisch transkript']])],
  ['uFR', new Map<string, string>([['Textniveau (GeR)', 'B1'], ['Lexiko-Grammatik', 'durchgängig komplex'],
    ['Abstraktionsgrad', 'durchgängig abstrakt'], ['Thematischer Vertrautheitsgrad', 'nicht vertraut'],
    ['Textsorte', 'Plakat'], ['Andere Textsorte', 'HomyII'], ['Thema', 'Tägliches Leben'],
    ['Anderes Thema', 'HomyyII'], ['Länge des verwendeten Audioauszugs', '5:30'], ['Wortanzahl', '200'],
    ['Aufgabenzeit', '6:00'], ['Vermerk / Zitation', 'DOIEnglisch'],
    ['Transkript Original', 'Französisch Transkript Original'], ['Anzahl der Sprecher*innen', '3'],
    ['Sprechtempo', 'normal'], ['Variante', 'Kreolisch'], ['Nebengeäausche', 'keine'],
  ...
  ['iEN', new Map<string, string>([['Item ID', '01'], ['Notiz', 'etwas Englisch'],
    ...
    ['Empirisch ermittelte GeR Niveaustufe', 'B1.1'], ['Itemformat', 'Table Completion(TC)'], ['Bildungsstandards ESA',
      'konkrete, voraussagbare Informationen in einfachen Gebrauchsstexten auffinden und verstehen.'],
    ['Bildungsstandards MSA',
      ''],
    ['Itemzeit', '1:00']])],
  ['iFR', new Map<string, string>([['Item ID', '01'], ['Notiz', 'etwas Französisch'],
    ['Lese-/Hörstil', 'global'], ['Geschätzte GeR Niveaustufe (a priori)', 'C1'],
    ['Empirisch ermittelte GeR Niveaustufe', 'C2.2'], ['Itemformat', 'Kurzantwortaufgabe'],
    ['Bildungsstandards ESA',
      'konkrete, voraussagbare Informationen in einfachen Gebrauchsstexten auffinden und verstehen.'],
    ['Bildungsstandards MSA',
      ''],
    ['Itemzeit', '2:00']])]
