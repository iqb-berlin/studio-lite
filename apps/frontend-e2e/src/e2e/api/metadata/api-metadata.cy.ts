...
//                         cy.createUnitAPI(Cypress.env(ws1.id), unit1, Cypress.env(`id_${Cypress.env('username')}`))
//                           .then(resp_u1 => {
...
//                           });
//                         cy.createUnitAPI(Cypress.env(ws1.id), unit2, Cypress.env(`id_${Cypress.env('username')}`))
//                           .then(resp_u2 => {
