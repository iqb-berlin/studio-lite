...
describe('Comments API tests', () => {
  ...
  describe('56. POST /api/workspaces/{workspace_id}/units/{id}/comments', () => {
    describe('56. POST /api/workspaces/{workspace_id}/units/{id}/comments', () => {
      ...
      it('500/201 negative test: should unexpectedly allow adding a comment even ' +
    ...
    describe('58. PATCH /api/workspaces/{workspace_id}/units/{id}/comments', () => {
      ...
      it('500 negative test: should return a server error when attempting to update timestamp' +
    ...
    describe('60. PATCH /api/workspaces/{workspace_id}/units/{id}/comments/{id}', () => {
      ...
      it('500 negative test: should return a server error when attempting to update a comment' +
      ...
      it('500/200 negative test: should return success despite attempting to update a comment' +
    ...
    describe('61. DELETE /api/workspaces/{workspace_id}/units/{id}/comments/{id}', () => {
      ...
      it('404/200 negative test: should return success despite providing an invalid ' +
