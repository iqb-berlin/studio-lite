import {
  addFirstUserAPI, createGroupAPI, createWsAPI, deleteFirstUserAPI, deleteGroupAPI, getUserIdAPI, setAdminOfGroupAPI
...
describe('API unit tests', () => {
  ...
  context('Preparing context', () => {
    ...
    it.skip('1. Create a Unit POST /api/workspace/id_workspace/units`', () => {
      console.log(Cypress.env(ws1.id));
